    ...
    public static Response4Log create4SpringMVC(PerformanceLogLevel performanceLogLevel, HttpServletRequest request, long elapsedTime,
        ...
        swallowException(() -> {
            ...
            if(!PerformanceLogLevel.MINIMUM.equals(performanceLogLevel)) {
                ...
                if(headerMap != null) {
                    response4Log.header = JsonUtils.object2Json(headerMap);
                }

                if(!PerformanceLogUtil.isIgnoreUrlParam(response4Log.uri)) {
            ...
            if(response != null) {
                ...
                if(!PerformanceLogLevel.MINIMUM.equals(performanceLogLevel)) {
                    if(response.getHeaders() != null) {
                        response4Log.header = JsonUtils.object2Json(response.getHeaders());
                    }
                }
            }
            ...
            if(response != null) {
                ...
                if(!PerformanceLogLevel.MINIMUM.equals(performanceLogLevel)) {
                    if(response.headers() != null) {
                        ...
                        response4Log.header = JsonUtils.object2Json(response.headers());
                    }
                }
            }
    ...
    public static Response4Log create4OkHttp(PerformanceLogLevel performanceLogLevel,  String requestURI, long elapsedTime,
        ...
        swallowException(() -> {
            ...
            if(response != null) {
                ...
                if(!PerformanceLogLevel.MINIMUM.equals(performanceLogLevel)) {
                    if(response.headers() != null) {
                        response4Log.header = JsonUtils.object2Json(removeIgnoreHeader(response.headers().toMultimap()));
                    }
                }
            }
