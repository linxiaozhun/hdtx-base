...
import com.hdtx.base.utils.text.StrFormatter;
...
public class StringUtils {
    ...
    private static String cutString(String s, int length) throws UnsupportedEncodingException {
        ...
        String result = new String(bytes, 0, i, Charset.forName("UTF-8"));

        if (i < bytes.length && !result.trim().equals("")) {
            result = result + "...";
        }
    ...
    public static boolean containsAnyIgnoreCase(CharSequence cs, CharSequence... searchCharSequences) {
        ...
        for (CharSequence testStr : searchCharSequences) {
            if (containsAnyIgnoreCase(cs, testStr)) {
                return true;
            }
        }
        return false;
